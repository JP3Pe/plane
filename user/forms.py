...
class UserRegisterForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'username': TextInput(attrs={'class': 'form-control', 'placeholder': '사용하실 닉네임을 입력해 주세요.'}),
            ...
            'first_name': TextInput(attrs={'class': 'form-control', 'placeholder': '당신의 이름을 입력해 주세요'}),
            'last_name': TextInput(attrs={'class': 'form-control', 'placeholder': '당신의 성을 입력해 주세요'})
        }
        labels = {
            'username': 'username',
            'email': 'email',
